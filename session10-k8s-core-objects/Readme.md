...
**Screenshot:**
![01-cluster-health](./screenshot/01-cluster-health.png)
...
**Screenshot:**
![02-nginx-pod-operations](./screenshot/02-nginx-pod-operations.png)
...
**Screenshot:**
![03-imagepullbackoff-error](./screenshot/03-imagepullbackoff-error.png)
...
**Screenshot:**
![04-pod-lifecycle-stages](./screenshot/04-pod-lifecycle-stages.png)
...
![05-lifecycle-probes-crashloop](./screenshot/05-lifecycle-probes-crashloop.png)

**Screenshot - Init Container and Multi-Container:**
![05-lifecycle-init-multicontainer](./screenshot/05-lifecycle-init-multicontainer.png)
...
**Screenshot:**
![06-controllers-rs-statefulset](./screenshot/06-controllers-rs-statefulset.png)
...
**Screenshot:**
![07-daemonset-verification](./screenshot/07-daemonset-verification.png)
...
**Screenshot:**
![08-rolling-update-and-rollback](./screenshot/08-rolling-update-and-rollback.png)
...
**Screenshot:**
![09-troubleshooting-drills](./screenshot/09-troubleshooting-drills.png)
...
**Screenshot:**
![11-blue-green-cutover](./screenshot/11-blue-green-cutover.png)
...
**Screenshot:**
![12-canary-traffic-split](./screenshot/12-canary-traffic-split.png)
...
**Screenshot:**
![13-recreate-downtime-outage](./screenshot/13-recreate-downtime-outage.png)
