...
**Screenshot:**
![Task 1 - Port Architecture](./screenshot/01-clusterip.png)
...
**Screenshot:**
![Task 2 - ClusterIP Service](./screenshot/01-clusterip.png)
...
**Screenshot:**
![Task 3 - NodePort Service](./screenshot/02-nodeport.png)
