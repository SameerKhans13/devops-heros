...
```bash
docker run -d --name nginx-bindmount -p 8085:80 -v "C:/Users/sameer/OneDrive/Documents/DevOps/devops-class/Assignments/session8-docker-networking-volume/bind-mount-demo:/usr/share/nginx/html" nginx:alpine
```
